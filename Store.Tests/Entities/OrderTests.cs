...
namespace Store.Tests.Entities
{
    ...
    public class OrderTests
    {
        ...
        private readonly Customer _customer = new Customer("Claudio José", "claudiojbf11@gmail.com");
        private readonly Product _product = new Product("Hamburguer", 20, true);
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_item_com_quantidade_zero_ou_menor_o_mesmo_nao_deve_ser_adcionado()
        {
            var order = new Order(_customer, 10, null);
        ...
        {
            var order = new Order(_customer, 20, new Discount(10, DateTime.Now.AddDays(-5)));
            order.AddItem(_product, 2);
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_desconto_valido_o_valor_do_pedido_deve_ser_50()
        {
